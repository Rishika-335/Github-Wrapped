  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="absolute bottom-6 flex flex-col items-center gap-1">
        <p className="text-white/15 text-xs font-mono">uses public github api · no login required</p>
        <p className="text-white/30 text-xs font-mono">made with ❤️ by Rishika</p>
      </div>
    </div>
  )
}
